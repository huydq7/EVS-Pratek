  ...
  return (
    ...
    >
      ...
      <Button
        ...
        className={cn(
          "mt-4 rounded-[100px] w-[182px]  lg:h-[52px] text-brand-secondary-dark lg:hover:w-full font-museo px-4 py-2 leading-7 text-[16px] hover:text-white bg-brand-secondary-veryLight font-semibold group-lg:hover:bg-brand-secondary-dark  transition-all duration-200",
          (isMobile || isTablet) && "text-[14px] w-fit h-fit mt-2 "
        )}
        variant="default"
      >
        Bắt đầu ngay
